        ...
        <div class="card-body">
            ...
            <form action="{{ route('courses.store') }}" method="POST">
              ...
              <div class="form-group">
                  ...
                  <input class="form-control" type="date" name="duration" id="html5-date-input" value="{{ old('duration', '2021-06-18') }}">
              </div>
              <div class="mb-3">
              ...
              <div class="form-group">
                  ...
                  <input class="form-control" type="date" name="deadline" id="deadline" value="{{ old('deadline', '2021-06-18') }}">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="price" name="price" placeholder="Amount" value="{{ old('price') }}">
              </div>
              <div class="form-group">
                  <label for="discount">Discount:</label>
                  <input type="text" class="form-control" id="discount" name="discount" placeholder="Amount" value="{{ old('discount') }}">
              </div>
              <div class="form-group">
              ...
              <div class="d-flex align-items-start mt-2">
                  <div id="learn" class="w-100 me-2">
                      ...
                      <div class="form-group l">
                          <input type="text" class="form-control" name="learn[]" value="{{ old('learn.0') }}">
                      </div>
                  </div>
                  <div>
              ...
              <div class="d-flex align-items-start mt-2">
                  <div id="requirements" class="w-100 me-2">
                      ...
                      <div class="form-group r">
                          <input type="text" class="form-control" name="requirements[]" value="{{ old('requirements.0') }}">
                      </div>
                  </div>
                  <div>
