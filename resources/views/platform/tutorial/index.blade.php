...
<div class="container pb-4 pb-xl-7">
            ...
            <div class="card border shadow p-2 lift sk-fade">
                ...
                <div class="card-zoom position-relative">
                    <div class="badge-float sk-fade-top top-0 right-0 mt-4 me-4">
                        <a href="course-single-v2.html" class="btn btn-xs btn-dark text-white rounded-circle lift opacity-dot-7 me-1 p-2 d-inline-flex justify-content-center align-items-center w-36 h-36">
                            <!-- Icon -->
                        ...
                        <a href="course-single-v2.html" class="btn btn-xs btn-dark text-white rounded-circle lift opacity-dot-7 p-2 d-inline-flex justify-content-center align-items-center w-36 h-36">
                            <!-- Icon -->
                ...
                <div class="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                    ...
                    <!-- Preheading -->
                    <a href="course-single-v2.html"><span class="mb-1 d-inline-block text-gray-800">{{ $t->categorie }}</span></a>

                    <!-- Heading -->
                    <div class="position-relative">
                        <a href="{{ route('tutorial_show',$t->slug) }}" class="d-block stretched-link"><h4 class="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">{{ $t->title }}</h4></a>
                        ...
                        <div class="row mx-n2 align-items-end">
                            ...
                            <div class="col-auto px-2 text-right">
                                ...
                                <ins class="h4 mb-0 d-block mb-lg-n1">${{ $t->price }}</ins>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div id="loadcollapseExample" class="row row-cols-md-2 row-cols-xl-3 mb-6 mb-xl-3 collapse" style="">
        <div class="col-md pb-4 pb-md-7">
            <!-- Card -->
            <div class="card border shadow p-2 lift sk-fade">
                <!-- Image -->
                ...
                <div class="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                    ...
                    <!-- Preheading -->
                    <a href="course-single-v2.html"><span class="mb-1 d-inline-block text-gray-800">Photography</span></a>

                    <!-- Heading -->
                    <div class="position-relative">
                        <a href="course-single-v2.html" class="d-block stretched-link"><h4 class="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">Fashion Photography From Professional</h4></a>
