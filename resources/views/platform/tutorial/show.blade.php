...
<div class="container">
    <div class="row mb-8">
        <div class="col-lg-8 mb-6 mb-lg-0 position-relative">
            ...
            <p class="me-xl-13 mb-5">{{ $course->about }}</p>
            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-overview" role="tabpanel" aria-labelledby="pills-overview-tab">
                    ...
                    <div class="row  mb-8">
                        <div class="col">
                            <ul class="list-style-v1 list-unstyled">
                                @foreach (explode(', ',$course->learn) as $r)
                                    <li>{{ $r }}</li>
                                @endforeach
                            </ul>
                        </div>
                    ...
                    <ul class="list-style-v2 list-unstyled">
                        @foreach (explode(', ',$course->requirements) as $r)
                            <li> {{ $r }} </li>
                        @endforeach
                    </ul>
                </div>
                    ...
                    <div id="accordionCurriculum">
                        ...
                        @foreach ($vids as $vid)
                            ...
                            <div class="border rounded shadow mb-6 overflow-hidden">
                                <div class="d-flex align-items-center" id="curriculumheadingOne{{ $vid->id }}">
                                    <h5 class="mb-0 w-100">
                                        <button class="d-flex align-items-center p-5 min-height-80 text-dark fw-medium collapse-accordion-toggle line-height-one" type="button" data-bs-toggle="collapse" data-bs-target="#CurriculumcollapseOne{{ $vid->id }}" aria-expanded="false" aria-controls="CurriculumcollapseOne{{ $vid->id }}">
        ...
        <div class="col-lg-4">
            ...
            <div class="d-block rounded border p-2 shadow mb-6">
                ...
                <div class="pt-5 pb-4 px-5 px-lg-3 px-xl-5">
                    ...
                    @if ($course->vids != '')
                    <a class="btn btn-blue btn-block mb-6" href="{{ route('video.watch',['id'=>$course->slug,'vid'=>$course->vids[0] ? $course->vids[0]->id : 0]) }}" name="button">Watch</a>
                    @endif
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item d-flex align-items-center py-3">
                            ...
                            <span>{{ \Carbon\Carbon::parse($course->duration)->weekOfYear  }} weeks</span>
                        </li>
                        <li class="list-group-item d-flex align-items-center py-3">
                            <div class="text-secondary d-flex icon-uxs">
                                <!-- Icon -->
                        ...
                        <li class="list-group-item d-flex align-items-center py-3">
                            ...
                            <span>{{ date('d M Y',strtotime($course->deadline))  }}</span>
                        </li>
                        <li class="list-group-item d-flex align-items-center py-3">
                            <div class="text-secondary d-flex icon-uxs">
                                <!-- Icon -->
                            ...
                            <span>{{ ucfirst($course->certificate) }}</span>
                        </li>
    ...
    <div class="mx-n4 mb-12 flickity-enabled is-draggable" data-flickity="{&quot;pageDots&quot;: true, &quot;prevNextButtons&quot;: false, &quot;cellAlign&quot;: &quot;left&quot;, &quot;wrapAround&quot;: true, &quot;imagesLoaded&quot;: true}" tabindex="0">
    ...
    <div class="flickity-viewport" style="height: 371.719px; touch-action: pan-y;"><div class="flickity-slider" style="left: 0px; transform: translateX(-25%);"><div class="col-md-6 col-lg-4 col-xl-3 pb-4 pb-md-5" style="padding-right: 15px; padding-left: 15px; position: absolute; left: 0%;" aria-hidden="true">
            <!-- Card -->
        ...
        </div><div class="col-md-6 col-lg-4 col-xl-3 pb-4 pb-md-5 is-selected" style="padding-right: 15px; padding-left: 15px; position: absolute; left: 25%;">
            <!-- Card -->
            <div class="card border shadow-dark-hover p-2 sk-fade">
                <!-- Image -->
                <div class="card-zoom position-relative">
        ...
        </div><div class="col-md-6 col-lg-4 col-xl-3 pb-4 pb-md-5" style="padding-right: 15px; padding-left: 15px; position: absolute; left: 50%;" aria-hidden="true">
            <!-- Card -->
            <div class="card border shadow-dark-hover p-2 sk-fade">
                <!-- Image -->
                <div class="card-zoom position-relative">
        ...
        </div><div class="col-md-6 col-lg-4 col-xl-3 pb-4 pb-md-5" style="padding-right: 15px; padding-left: 15px; position: absolute; left: 75%;" aria-hidden="true">
            <!-- Card -->
            <div class="card border shadow-dark-hover p-2 sk-fade">
                <!-- Image -->
                <div class="card-zoom position-relative">
        ...
        </div><div class="col-md-6 col-lg-4 col-xl-3 pb-4 pb-md-5" style="padding-right: 15px; padding-left: 15px; position: absolute; left: 100%;" aria-hidden="true">
            <!-- Card -->
            <div class="card border shadow-dark-hover p-2 sk-fade">
                <!-- Image -->
                <div class="card-zoom position-relative">
        ...
        </div><div class="col-md-6 col-lg-4 col-xl-3 pb-4 pb-md-5" style="padding-right: 15px; padding-left: 15px; position: absolute; left: 125%;" aria-hidden="true">
            <!-- Card -->
            <div class="card border shadow-dark-hover p-2 sk-fade">
                <!-- Image -->
                <div class="card-zoom position-relative">
        ...
        </div><div class="col-md-6 col-lg-4 col-xl-3 pb-4 pb-md-5" style="padding-right: 15px; padding-left: 15px; position: absolute; left: 150%;" aria-hidden="true">
            <!-- Card -->
            <div class="card border shadow-dark-hover p-2 sk-fade">
                <!-- Image -->
                <div class="card-zoom position-relative">
        ...
        </div></div></div><ol class="flickity-page-dots"><li class="dot" aria-label="Page dot 1"></li><li class="dot is-selected" aria-label="Page dot 2" aria-current="step"></li><li class="dot" aria-label="Page dot 3"></li><li class="dot" aria-label="Page dot 4"></li><li class="dot" aria-label="Page dot 5"></li><li class="dot" aria-label="Page dot 6"></li><li class="dot" aria-label="Page dot 7"></li></ol></div>
</div>
